...
sleep(2)
print("\nWelcome to the path of learning English. I am glad you have completed the A2 level(Level: B1)")
sleep(2)
print("This program aims to memorize English words at B1 level with daily repetition.")
sleep(3)
...
sleep(4)
print("Each word you remove from the list is worth a new word. Once the list is complete, you can move on to B2 or higher levels.")
sleep(2)
